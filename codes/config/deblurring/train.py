...
def main():
    ...
    parser.add_argument("-opt", type=str, default="/home/username/mywork/image-restoration-sde/codes/config/deblurring/options/train/ir-sde.yml" , help="Path to option YMAL file.")
    parser.add_argument(
    ...
    #创建随机微分方程（SDE）相关对象和设置相关参数
    print("==创建随机微分方程(SDE)相关对象和设置相关参数==")
